...
public class BirdTrailParticle extends DustParticle implements ParticleOptions {
    ...
    public BirdTrailParticle(ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, SimpleParticleType type, SpriteSet sprites) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType>{
        ...
        public @Nullable Particle createParticle(SimpleParticleType type, ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            return new BirdTrailParticle(level, x, y, z, xSpeed, ySpeed, zSpeed, type, sprites);
        }
    }
}
