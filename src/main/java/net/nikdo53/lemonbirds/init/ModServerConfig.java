...
public interface ModServerConfig {
    ...
    ModConfigSpec.DoubleValue SLINGSHOT_PITCH_MULTIPLIER = BUILDER
            .translation("lemonbirds.configuration.slingshot_pitch_multiplier")
            .defineInRange("slingshot_pitch_multiplier", 1.0d, 0.0d, 3.0d);
